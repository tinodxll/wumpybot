    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow bg-gradient-to-br from-gray-900 via-blue-900 to-blue-800 flex items-center justify-center px-4 py-32">
        <div className="text-center max-w-md w-full">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Instagram Coming Soon</h1>
          <p className="text-lg md:text-xl text-blue-100 mb-8">We're preparing our Instagram content. Check back soon!</p>
