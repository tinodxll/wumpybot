          ...
          <div className="flex flex-col items-center justify-center min-h-screen text-center gap-8 pt-24 md:pt-16 pb-32">
            {isAuthenticated ? (
              ...
              >
                ...
                >
                  New Admin Panel Under Construction
                </motion.h1>
                <motion.p 
                ...
                >
                  We're building a powerful new admin panel to manage Wumpy Bot more efficiently. 
              ...
              <AdminPasswordPrompt onCorrectPassword={() => setIsAuthenticated(true)} />
            )}
          </div>
        </div>
